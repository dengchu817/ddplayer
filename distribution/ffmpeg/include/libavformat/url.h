 ...
 * m_url, but do not initiate the connection yet.
 *
 ...
 * @see av_url_split
 *
 * @param str the buffer to fill with the m_url
...
/**
 * Convert a relative m_url into an absolute m_url, given a base m_url.
 *
 * @param buf the buffer where output absolute m_url is written
 * @param size the size of buf
 * @param base the base m_url, may be equal to buf.
 * @param rel the new m_url, which is interpreted relative to base
 */

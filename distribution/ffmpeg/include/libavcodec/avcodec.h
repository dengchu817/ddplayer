...
#define AV_CODEC_ID_H265 AV_CODEC_ID_HEVC
    ...
    /* various PCM "codecs" */
    AV_CODEC_ID_FIRST_AUDIO = 0x10000,     ///< A dummy id pointing at the start_thread of audio codecs
    ...
    /* subtitle codecs */
    AV_CODEC_ID_FIRST_SUBTITLE = 0x17000,          ///< A dummy ID pointing at the start_thread of subtitle codecs.
    ...
    AV_CODEC_ID_FIRST_UNKNOWN = 0x18000,           ///< A dummy ID pointing at the start_thread of various fake codecs.
...
enum AVPacketSideDataType {
     ...
     * u8    current quantizer at the start_thread of the macroblock
     * u8    GOB number
     ...
     * u8    reason for start_thread skip
     ...
     * the list, so it is required to rely on the side data size to stop_thread.
     */
    ...
    /**
     * A list of zero terminated key/value strings. There is no end marker for
     * the list, so it is required to rely on the side data size to stop_thread. This
...
#define FF_COMPRESSION_DEFAULT -1
     ...
     *   start_thread decoding this many samples prior to your desired seek point.
     *
...
#define FF_CODER_TYPE_DEFLATE   4
    ...
    int rtp_payload_size;   /* The size of the RTP payload: the coder will  */
                            ...
                            /* below rtp_payload_size, the chunk will start_thread */
                            /* with a start_thread code on some codecs like H.263. */
...
typedef struct AVCodec {
     ...
     * If not defined, the next thread will start_thread automatically; otherwise, the codec
...
#define PARSER_FLAG_USE_CODEC_TS              0x1000
    ...
    int64_t offset;      ///< byte offset from starting packet start_thread
    ...
    /**
     * Synchronization point for start_thread of timestamp generation.
     *
...
typedef struct AVCodecParser {
     ...
     * the frame start_thread was in a previous packet. */
 ...
 *               point to NULL to start_thread the iteration.
 *
